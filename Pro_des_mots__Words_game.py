...
Mots_faciles = ['lac','loi','moi','toi','roi','fou','pion','lui','nez','son','dur','mou','fin','fil','eau','riz','bas','air','bar','sol','ski','rue','vie','nez']
Mots_moyens = ['tour','dame','haut','loup','nuit','jour','ciel','lune','chat','lion','ours','toit','suie','tutu','pull','luge','gris','bleu','noir','rose','vert','brun','roux','lait','kiwi','paix','chou','pois','cuir','jupe','mere','pere','fils','moto','velo','pull','yoyo','rond','jedi','sith']
Mots_difficiles = ['pluie','coeur','livre','pomme','ferme','barre','plume','prune','poire','bille','tuile','chien','puits','stylo','bisou','blanc','beige','rubis']
